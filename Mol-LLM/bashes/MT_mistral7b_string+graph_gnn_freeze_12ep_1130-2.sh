...
ckpt_path="'/data/all_checkpoints/MT_mistral7b_string+graph_gnn_freeze_12ep_1130_copy/MT_mistral7b_string+graph_gnn_freeze_12ep_1130/step=04500-train_total_loss=0.115.ckpt'"
