...
file_name='qm9_molpo_from-string+graph_rej-lambda9.0'
...
trainer.inference_batch_size=14 \
trainer.reject_lambda=9.0 \
ckpt_path="'/data/all_checkpoints/qm9_molpo_from-string+graph_rej-lambda9.0/last.ckpt'"
