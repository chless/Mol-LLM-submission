...
file_name='qm9_molpo_from-string+graph_rej-lambda8.0'
gpus="',2,3,4,5,6,7'"
...
trainer.reject_lambda=8.0 \
ckpt_path="'/data/all_checkpoints/qm9_molpo_from-string+graph_rej-lambda6.0/last.ckpt'"
