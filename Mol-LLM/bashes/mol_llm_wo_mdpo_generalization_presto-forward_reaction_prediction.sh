...
file_name='mol_llm_wo_mdpo_generalization_presto-forward_reaction_prediction'
...
ckpt_path="'/data/all_checkpoints/MT_mistral7b_string+graph2string+graph_5ep_lr2e-5_0124/epoch=01-step=4861.ckpt'" \
