...
file_name='qm9_tasks_mistral7b_string_only_mdpo_0117'
...
filename=$file_name \
data=qm9_3tasks \
data.data_tag=qm9_3tasks_offline \
...
trainer.mol_representation=string \
trainer.total_batch_size=256 \
trainer.simpo_modality=string_only \
