...
file_name='mol_llm_mdpo_generalization_presto-reagent_prediction_step9723'
gpus="'0'"
...
mode=test \
data=multi_task \
data.data_tag=presto-reagent_prediction \
...
ckpt_path="'/data/all_checkpoints/MT_mistral7b_string+graph2string+graph_mdpo_5ep_lr_0124/epoch=03-step=9723.ckpt'" \
