...
filename=MT_${task}_${modality}_molpo_dump_0318 \
...
ckpt_path="'/data/all_checkpoints/MT_mistral7b_string+graph2string+graph_mdpo_5ep_lr_0124/epoch=04-step=12154.ckpt'"
