...
def preprocess_reaction_data_instance(instance):
...
def preprocess_property_data_instance(instance):
    input_selfies = wrap_selfies_in_special_tokens(instance['input'])
...
def preprocess_data_split(split):
    ...
    for i in range(len(iter_bar)):
        ...
        if split_instance['metadata']['task'] in ['forward reaction prediction', 'retrosynthesis', 'reagent prediction']:
            instance = preprocess_reaction_data_instance(split_instance)
        elif split_instance['metadata']['task'] in ['property prediction']:
            instance = preprocess_property_data_instance(split_instance)
        instance['id'] = i
