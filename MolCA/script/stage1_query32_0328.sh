...
python MolCA/stage1.py --root 'MolCA/data/PubChem324kV2/' --gtm --lm --devices '6,7' --mode train --filename stage1_query32 --rerank_cand_num 128 --num_query_token 32 --tune_gnn --filtered_cid_path data/PubChem324k/filtered_pretrain_cids.txt
