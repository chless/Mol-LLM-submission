...
--filename MT_galac1.3b_string_only_grad_accum8_lr1e-3_0919 \
--scheduler None \
--valset_resize 2400 \
--init_lr 1e-3 \
--accumulate_grad_batches 8 \
--every_n_train_steps 100 \
--ckpt_path MolCA/all_checkpoints/MT_galac1.3b_string_only_grad_accum8_lr1e-4_0912/last-v1.ckpt \
