...
def main(args):
    ...
    if args.init_checkpoint:
        model = GraphReconstruction.load_from_checkpoint(
            args.init_checkpoint, device=args.devices, args=args
        )
...
class GraphReconstruction(pl.LightningModule):
    def __init__(self, args):
        ...
        self.encoder, self.ln_graph = self.init_graph_encoder(
            args.gin_num_layers, args.gin_hidden_dim, args.drop_ratio
        )
    ...
    # TODO: Implement this and substitute the load_graph_decoder in the other file
    def load_graph_decoder(self, args):
        pass
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log(
            "val_atom_type_loss",
            output.atom_type_loss,
            batch_size=batch_size,
            sync_dist=True,
        )
        self.log(
            "val_chirality_tag_loss",
            output.chirality_tag_loss,
            batch_size=batch_size,
            sync_dist=True,
        )
        return output
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log(
            "test_atom_type_acc",
            (pred_atom == true_atom).float().mean(),
            batch_size=batch_size,
            sync_dist=True,
        )
        self.log(
            "test_chirality_tag_acc",
            (pred_chiral == true_chiral).float().mean(),
            batch_size=batch_size,
            sync_dist=True,
        )
